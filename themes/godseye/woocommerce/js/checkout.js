	...
	$('form.checkout').validate({
		...
		messages: {
			additional_wooccm1: {
				...
				regex: 'Please enter valid Vehicle Registration number.'
			},
			additional_wooccm5: {
			...
			additional_wooccm0: {
				required: "Please upload valid ID proof.",
				// extension: "Please upload valid ID PRoof in png, jpg, jpeg format",			
			},
			additional_wooccm3: {
				required: "Please upload valid Vehicle RC.",
				// extension: "Please upload valid Vehicle RC in png, jpg, jpeg format",
			},
			additional_wooccm4: {
				required: "Please upload valid Address proof.",
				// extension: "Please upload valid Address proof in png, jpg, jpeg format",
