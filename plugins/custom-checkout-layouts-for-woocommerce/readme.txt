...
Tags: checkout,faster checkout,woocommerce checkout,one page checkout,single page checkout, woocommerce one page checkout,one page checkout and layouts,one page checkout ajax
...
Woocommerce one page checkout and layouts Improves checkout experience to make your customers to purchase at same page combining cart and checkout page.
...
<ul>
    <li>Login Section</li>
	<li>Search Products and add to cart</li>
 	<li>Billing Details</li>
 	<li>Shipping Section</li>
 	<li>Payments Section</li>
 	<li>Order review and change quantity section</li>
 	<li>Coupon apply &amp; Place order</li>
</ul>
...
<h3>Search Products at Checkout</h3>
Missed something? Then here is a search section which will help you to search required product and add to you order instantly.
...
== Screenshots ==
1. frontend checkout page layout
2. admin settings panel 
3. removing products and changing qty at checkout
4. search products by product name

== Changelog == 
<h2> Version 1.5| 1 November 2019 </h2>
<pre>
...
<h2> Version 1.4| 25 August 2019 </h2>
<pre>
