...
?>
<p style="margin-bottom: 10px;"><?php echo esc_html__( 'Have a coupon? ', 'cclw' ); ?><a href="#" class="showcoupon">Click Here.</a></p>
<form class="checkout_coupon expresss-one-page-coupen" method="post" style="display:none" >
	...
	<p class="form-row form-row-last">
		<input type="submit" class="coupon_button cclw_button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'cclw' ); ?>" />
	</p>
