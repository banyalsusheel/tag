...
<table class="onestepcheckout-summary">
        ...
        <td class="total">
		 ...
		 <td class="removepro">
		  ...
		  printf(
						...
						?>
		 <a href="<?php echo  esc_url( wc_get_cart_remove_url( $cart_item_key ) );?>" class="remove" title="Remove this item">×</a>				
		 </td>	
	...
	<!--	<h3 class="border_html"><?php //esc_html_e('Order total', 'cclw'); ?></h3>-->
	   ...
	   <?php 
			...
			if($chosen_method != '')
			{
				$cost = get_woocommerce_currency_symbol().''.$package['rates'][$chosen_method]->get_cost();
			}
            else
			{
				$cost = '---';
			...
			<span class="right-corner"><?php echo $cost;?></span>
		</div>  
